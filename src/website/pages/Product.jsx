            ...
            {data.map((value, index) => (
                <div key={index} className="col">
                    <div className="card shadow-sm h-100">
                        <img src={value.cate_img} className="card-img-top rounded" alt={value.cate_name} />
                        <div className="card-body d-flex flex-column justify-content-between">
                            <h5 className="card-title">{value.cate_name}</h5>
                            <p className="card-text">{value.id}</p>
                            <button onClick={() => redirect('/viewproducts/' + value.id)} className="btn btn-primary btn-sm mt-auto">View Details</button>
                        </div>
                    </div>
                </div>
            ))}
      ...
      <div className="row g-5">
        ...
        <div className="col-lg-6">
          <div className="d-block bg-white h-100 text-center p-5 pb-lg-0">
            ...
            <img className="img-fluid" src="website/img/feature.png" alt='pic' />
          </div>
        </div>
        <div className="col-lg-3">
          <div className="text-white mb-5">
